...
function setSliderItems(count) {
    ...
    for (let i = 0; i < count; i++) {
        ...
        <span class="slider-text">Модульн  комплект комплект комплект комплект комплект комплект  Ментор CRUZO <span>штучний ротанг, сірий, dm0011</span></span>
        <div class="slider-price-wrap">
          <div class="slider-info">
            <button class="slider-btn">Замовити</button>
            <div class="slider-price">
              <span class="slider-sale">10 500 грн</span>
              <span class="slider-main-price">3 500 </span>
            </div>
          </div>
        </div>
      </div>
        `
        $('.owl-carousel').append(x);
    }
}
setSliderItems(20);